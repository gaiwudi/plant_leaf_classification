...
# loss 2.63238215735882
# acc tensor(0.0944, device='cuda:0', dtype=torch.float64)
# loss 2.603049163873485
# acc tensor(0.1355, device='cuda:0', dtype=torch.float64)
# loss 2.5736082155580466
# acc tensor(0.1698, device='cuda:0', dtype=torch.float64)
# loss 2.5635571665846544
# acc tensor(0.1814, device='cuda:0', dtype=torch.float64)
# loss 2.556700477848163
# acc tensor(0.1890, device='cuda:0', dtype=torch.float64)
# loss 2.5450742290199146
# acc tensor(0.2032, device='cuda:0', dtype=torch.float64)
# loss 2.5432192393810076
# # acc tensor(0.2033, device='cuda:0', dtype=torch.float64)