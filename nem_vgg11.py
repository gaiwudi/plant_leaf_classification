...
# loss 2.2987740778509593
# acc tensor(0.4743, device='cuda:0', dtype=torch.float64)
# loss 2.1243001607112113
# acc tensor(0.6458, device='cuda:0', dtype=torch.float64)
# loss 2.086530014407428
# acc tensor(0.6806, device='cuda:0', dtype=torch.float64)
# loss 2.058589351935194
# acc tensor(0.7059, device='cuda:0', dtype=torch.float64)
# loss 2.0426639849050887
# acc tensor(0.7210, device='cuda:0', dtype=torch.float64)
# loss 2.0311236516588687
# acc tensor(0.7318, device='cuda:0', dtype=torch.float64)
# loss 2.018684046392496
# acc tensor(0.7425, device='cuda:0', dtype=torch.float64)
# loss 2.0149293918830122
# acc tensor(0.7464, device='cuda:0', dtype=torch.float64)
# loss 2.0107229446400106
# acc tensor(0.7496, device='cuda:0', dtype=torch.float64)
# loss 1.9987140611417031
# acc tensor(0.7616, device='cuda:0', dtype=torch.float64)
